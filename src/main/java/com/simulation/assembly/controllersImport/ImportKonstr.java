...
import com.simulation.assembly.dataCalculation.sintez.DataKonstrKA;
...
public class ImportKonstr extends ImportElement {

    public TextField mkKA;
    public TextField vkKA;
    public TextField jkKA;

    private List<DataElement> listLoad = new ArrayList<>();

    private TabTypeSintez tabTypeSintez = TabTypeSintez.KONSTR;                                               //

    @Override
    public void addElement(ActionEvent actionEvent) {
        DataKonstrKA data = new DataKonstrKA();                                                                     //

        try {
            data.mkKA = ValidateValue.conversionTextToFloat(mkKA.getText());                                  //
            data.vkKA = ValidateValue.conversionTextToFloat(vkKA.getText());
            data.jkKA = ValidateValue.conversionTextToFloat(jkKA.getText());
        } catch (Exception e) {
    ...
    public void selectElement(ActionEvent actionEvent) {
        DataKonstrKA data = (DataKonstrKA) tableChoise.getSelectionModel().getSelectedItem();                       //
        if (data==null){
        ...
        CalculationKA.getInstance().setDataKonstrKA(data);                                                      //                                                   //
        ...
        stage.close();
        ControllerAssembly.getInstance().onLabelZaimKonstr(data.getNameElement());
    }
