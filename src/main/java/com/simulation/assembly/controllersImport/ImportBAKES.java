...
public class ImportBAKES extends ImportElement {

    public TextField mKIS;
    public TextField vKIS;
    public TextField wKIS;
    public TextField jKIS;

    private List<DataElement> listLoad = new ArrayList<>();

    private TabTypeSintez tabTypeSintez = TabTypeSintez.BAKIS;                                               //
    ...
    public void selectElement(ActionEvent actionEvent) {
        DataBAKES data = (DataBAKES) tableChoise.getSelectionModel().getSelectedItem();                       //
        if (data==null){
        ...
        CalculationKA.getInstance().setDataBAKES(data);                                                      //                                                   //
        ...
        stage.close();
        ControllerAssembly.getInstance().onLabelZaimBaKis(data.getNameElement());
    }
