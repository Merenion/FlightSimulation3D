...
public class ImportIPMV extends ImportElement {

    private List<DataElement> listLoad = new ArrayList<>();

    private TabTypeSintez tabTypeSintez = TabTypeSintez.IPMV;                                               //
    ...
    public void addElement(ActionEvent actionEvent) {
        try {
            ...
            addElement.addElement(new DataIPMV());                                                          //
            initialize();
    ...
    public void selectElement(ActionEvent actionEvent) {
        try {
            ...
            DataIPMV data = (DataIPMV) tableChoise.getSelectionModel().getSelectedItem();                       //
            ...
            CalculationKA.getInstance().setDataIPMV(data);                                                      //                                                   //
