...
public class ImportSPPE extends ImportElement {
    ...
    public void addElement(ActionEvent actionEvent) {
        ...
        try {
            data.mSPPI = ValidateValue.conversionTextToFloat(mSPPI.getText());                                  //
            data.vSPPI = ValidateValue.conversionTextToFloat(vSPPI.getText());
            data.wSPPI = ValidateValue.conversionTextToFloat(wSPPI.getText());
            data.jSPPI = ValidateValue.conversionTextToFloat(jSPPI.getText());
        } catch (Exception e) {
