...
public class ImportSPPE extends ImportElement {

    public TextField mSPPI;
    public TextField vSPPI;
    public TextField wSPPI;
    public TextField jSPPI;
    ...
    public void addElement(ActionEvent actionEvent) {
        DataSPPE data = new DataSPPE();                                                                     //

        try {
            data.m = ValidateValue.conversionTextToFloat(mSPPI.getText());                                  //
            data.v = ValidateValue.conversionTextToFloat(vSPPI.getText());
            data.w = ValidateValue.conversionTextToFloat(wSPPI.getText());
            data.j = ValidateValue.conversionTextToFloat(jSPPI.getText());
        } catch (Exception e) {
    ...
    public void selectElement(ActionEvent actionEvent) {
        ...
        ControllerAssembly.getInstance().showSPEEResult();
