...
public class ImportDO extends ImportElement {

    private List<DataElement> listLoad = new ArrayList<>();

    private TabTypeSintez tabTypeSintez = TabTypeSintez.DO;                                                  //
    ...
    public void addElement(ActionEvent actionEvent) {
        try {
            ...
            addElement.addElement(new DataDO());                                                          //
            initialize();
    ...
    public void selectElement(ActionEvent actionEvent) {
        ...
        try {
            ...
            DataDO data = (DataDO) tableChoise.getSelectionModel().getSelectedItem();                       //
            ...
            CalculationKA.getInstance().setDataDO(data);                                                      //                                                   //
